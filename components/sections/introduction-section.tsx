  ...
  return (
    <section id="way" className="intro-section px-5 py-24 sm:px-8 sm:py-32 lg:px-12">
      <div className="mx-auto grid max-w-[1240px] gap-12 lg:grid-cols-[.7fr_1.3fr] lg:gap-24">
        <div>
          <p className="eyebrow text-[#c65d3f]" data-testid="text-intro-kicker">{content.introduction.kicker}</p>
          <div className="mt-6 flex items-center gap-3 text-[#c65d3f]">
            <span className="h-px w-16 bg-[#c65d3f]" /><span className="font-mono-display text-[10px]">01 / 04</span>
          </div>
        </div>
        <div>
